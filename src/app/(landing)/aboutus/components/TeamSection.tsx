...
const { RiGlobalFill, Loader2Icon, AlertCircle, UsersRound } = Icon;
            ...
            <div className="mx-auto max-w-6xl px-6">
                ...
                {isLoading ? (
                    <div className="flex justify-center items-center py-20">
                        <Loader2Icon size={48} className="animate-spin text-[#076490]" />
                    </div>
                ) : error ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center gap-3">
                        <UsersRound size={48} className="text-gray-400" />
                        <p className="text-gray-500 font-medium text-base">No hay miembros del equipo disponibles en el momento</p>
